...
void Player::Init(int entityType, sf::Vector2i screenDimensions, int initPosX, int initPosY, sf::Texture& texture, sf::Vector2i mapSize)
{
	Entity::Init(screenDimensions, initPosX, initPosY, texture, mapSize, entityType);
	// Camera Init
